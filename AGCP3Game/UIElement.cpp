...
void UIElement::Init(DeviceManager* dManager, std::string texPath, DirectX::SimpleMath::Vector2 position, DirectX::SimpleMath::Vector2 scale, DirectX::SimpleMath::Vector2 size, RECT rect)
{
	mPos = position;
	mScale = scale;
	mSize = size;
...
void UIElement::Render(DeviceManager* dManager)
{
...
void UIElement::OnClicked(ResourceManager* rManager, DeviceManager* dManager)
{
}

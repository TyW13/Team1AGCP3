...
//void ResourceManager::ReloadMap(int mapNum)
//{
//	SetCurrentMap(mapNum);
//
//	LoadZoneInfo(GetCurrentMap()->GetCurrentZoneNum());								// Calls the LoadZoneInfo function of currentmap, giving the currentzone we want to load
//}
//
...
//}
//
//void ResourceManager::LoadZoneInfo(int zoneNum)
//{
//	UnloadZone();
//
...
//			if (objType == "Tile")
//			{   	
//				Tile* newTile = new Tile(GetTexture("test_sheet2"), Vector2(tileXPos, tileYPos), Vector2(6, 6), true, Vector2(GetCurrentMap()->getTileWidth(), GetCurrentMap()->getTileHeight()), objType, true, tileRect);				// Creating and pushing tile objects to m_Tiles vector

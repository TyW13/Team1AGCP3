...
//	{
//		Data() {}
//		Data(const std::string& fName, ID3D12Resource* p, const DirectX::SimpleMath::Vector2& _dim)
//			: fileName(fName), pTex(p), dim(_dim)
//		{
//			frames.clear();
//		}
//		Data(const std::string& fName, ID3D12Resource* p, const DirectX::SimpleMath::Vector2& _dim, const std::vector<RECTF>* _frames)
//			:fileName(fName), pTex(p), dim(_dim)
//
//		{
//			if (_frames)
...
//	ID3D12Resource* LoadTexture(ID3D12Device* device, const std::string& fileName, const std::string& texName = "", bool appendPath = true, const std::vector<RECTF>* _frames = nullptr);
...
//	const Data& Get(ID3D12Resource* pTex);
//
//private:
//	DirectX::SimpleMath::Vector2 GetDimensions(ID3D12Resource* pTex);
